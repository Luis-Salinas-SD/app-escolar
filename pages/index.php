...
<body class="g-sidenav-show  bg-gray-300">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
        ...
        <div class="container py-10 postion-relative z-index-2">
          <div class="row">
            <div class="col-md-6 mx-auto text-center">
              <h2 class="text-white">Software Incorp</h2>
      ...
      <div class="container-fluid px-4 my-6 w-90">
                              ...
                              <div class="timeline-content pt-1">
                                ...
                                <div class="d-flex flex-column">
                                  <div class="d-flex align-items-center mt-2">
                                    ...
                                    <h6 class="mb-0 text-dark text-sm mx-1">Website Completo</h6>
                                  </div>
                                  <div class="d-flex align-items-center mt-2">
                                    <div class="form-check is-filled">
                                      <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
